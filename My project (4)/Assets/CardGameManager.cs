        ...
        switch (State)
        {
            ...
            case GameState.Damages:
                if (P1.IsAnimating() == false && P2.IsAnimating() == false)
                {
                    if (damagedPlayer == P1)
                    {
                        P1.ChangeHealth(-defaultPlayerStats.DamageValue);
                        P2.ChangeHealth(defaultPlayerStats.RestoreValue);
                    }
                    else
                    {
                        P1.ChangeHealth(defaultPlayerStats.RestoreValue);
                        P2.ChangeHealth(-defaultPlayerStats.DamageValue);
                    }
